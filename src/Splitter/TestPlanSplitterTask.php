...
/**
 * @see \Tests\Codeception\Task\Splitter\TestPlanSplitterTask
 */
class TestPlanSplitterTask extends TestsSplitter
{
    private ?string $reportPath = null;

    /**
     * @return string - the absolute path to the report file with testplan
     */
